...
class GROVERTrainer:
    def __init__(self,
        ...
        self.model = GroverTask(args, embedding_model, atom_vocab_size, bond_vocab_size, fg_szie, feature_vocab_size)
    ...
    def iter(self, epoch, data_loader, train=True) -> List:
        ...
        av_loss_sum, bv_loss_sum, fg_loss_sum, av_dist_loss_sum, bv_dist_loss_sum, fg_dist_loss_sum, af_loss_sum, af_dist_loss_sum = 0, 0, 0, 0, 0, 0, 0, 0
        ...
        for i, item in enumerate(data_loader):
            ...
            if next(self.model.parameters()).is_cuda:
                ...
                targets["af_task"] = targets["af_task"].cuda()
            ...
            loss, av_loss, bv_loss, fg_loss, av_dist_loss, bv_dist_loss, fg_dist_loss, af_loss = self.loss_func(preds, targets)
            ...
            # Debug only.
            if i % 50 == 0:
                print(f"epoch: {epoch}, batch_id: {i}, loss: {loss}, av_loss: {av_loss}, bv_loss: {bv_loss}, af_loss: {af_loss}"
