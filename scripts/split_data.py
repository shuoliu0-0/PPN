...
parser.add_argument("--data_path", default="data/path/data_example.csv")
parser.add_argument("--features_path", default="save/path/data_example.npz")
parser.add_argument("--sample_per_file", type=int, default=2000)
parser.add_argument("--output_path", default="output/path/data_example")
