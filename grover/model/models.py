...
class FunctionalGroupPrediction(nn.Module):
    ...
    def __init__(self, args, fg_size):
        ...
        self.linear_af_from_atom = nn.Linear(first_linear_dim, fg_size)
    ...
    def forward(self, embeddings: Dict, ascope: List, bscope: List) -> Dict:
        ...
        preds_atom_from_atom, preds_atom_from_bond, preds_bond_from_atom, preds_bond_from_bond, preds_af_from_atom = \
        ...
        if embeddings["atom_from_atom"] is not None:
            preds_af_from_atom = self.linear_af_from_atom(self.readout(embeddings["atom_from_atom"], ascope))
        ...
        return {"atom_from_atom": preds_atom_from_atom, "atom_from_bond": preds_atom_from_bond,
                ...
                "af_from_atom": preds_af_from_atom}
...
class GroverTask(nn.Module):
    ...
    The pretrain module.
    """
    def __init__(self, args, grover, atom_vocab_size, bond_vocab_size, fg_size, feature_vocab_size):
        ...
        self.af_task_atom = AtomVocabPrediction(args, feature_vocab_size)
    ...
    def get_loss_func(args: Namespace) -> Callable:
        ...
        def loss_func(preds, targets, dist_coff=args.dist_coff):
            ...
            av_atom_loss, av_bond_loss, av_dist_loss, af_atom_loss = 0.0, 0.0, 0.0, 0.0
            ...
            if preds["af_task"][0] is not None:
                af_atom_loss = av_task_loss(preds['af_task'][0], targets["af_task"])
                fg_af_from_atom_loss = fg_task_loss(preds["fg_task"]["af_from_atom"], targets["fg_task"])
            ...
            fg_loss = fg_atom_loss + fg_bond_loss + 2*fg_af_from_atom_loss
            ...
            overall_loss = av_loss + bv_loss + fg_loss + dist_coff * av_dist_loss + \
                           dist_coff * bv_dist_loss + fg_dist_loss + af_atom_loss

            return overall_loss, av_loss, bv_loss, fg_loss, av_dist_loss, bv_dist_loss, fg_dist_loss, af_atom_loss
