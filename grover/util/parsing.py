...
def add_pretrain_args(parser: ArgumentParser):
    ...
    parser.add_argument('--atom_vocab_path', type=str, help="Path to the atom vocabulary.")
    parser.add_argument('--bond_vocab_path', type=str,
                        help="Path to the bond vocabulary.")
    parser.add_argument('--graph_vocab_path', type=str, default='path',help="Path to the graph vocabulary.")
    parser.add_argument('--feature_vocab_path', type=str, default='path',help="Path to the feature vocabulary.")
...
def modify_train_args(args: Namespace):
    ...
    if not ((args.dataset_type == 'classification' and args.metric in ['auc', 'screening_metrics', 'ef', 'prc-auc', 'accuracy']) or
